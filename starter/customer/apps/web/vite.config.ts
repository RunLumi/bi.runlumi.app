...
export default defineConfig({plugins:[react(),tailwindcss()],resolve:{alias:[{find:'@lumi/tailwind',replacement:fileURLToPath(new URL('../../tailwind.css',import.meta.url))}],dedupe:['react','react-dom']},
