...
console.log('Operator steps are in docs/DEPLOYMENT.md: configure customer-owned Access, migrate core then customer ledger, deploy the Worker, verify Access and D1 identity.');
