...
try{
 ...
 await writeFile(path.join(work,'package.json'),JSON.stringify({name:'workerd-check',private:true,type:'module',dependencies:{'@runlumi/core':`file:${artifacts}/runlumi-core-0.1.2.tgz`,'@runlumi/cloudflare':`file:${artifacts}/runlumi-cloudflare-0.1.2.tgz`},devDependencies:{'@types/node':'22.18.6'}},null,2));
