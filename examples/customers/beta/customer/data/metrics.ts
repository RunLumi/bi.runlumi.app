...
export const customMetrics:readonly CustomMetric[]=[
 {id:assertNamespace('customer.channel_margin_note'),label:'Ghi chú biên lợi nhuận kênh (Beta)',unit:'count',definition:'Chỉ số mở rộng của Beta; không thay thế chỉ số dùng chung.',source:{kind:'derived',from:['operations.cases'],note:'Synthetic fixture. Requires review before production use.'}}
];
